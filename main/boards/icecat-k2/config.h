...
#define DISPLAY_WIDTH_POR  240 
#define DISPLAY_HEIGHT_POR  320 
#define DISPLAY_MIRROR_X_POR false
#define DISPLAY_MIRROR_Y_POR false 
#define DISPLAY_SWAP_XY_POR false 
