...
#define TAG "ICECATK2BOARD_ML307"
...
class ICECATK2BOARD_ML307 : public DualNetworkBoard {
private:
...
//            ESP_LOGI(TAG, "Shutting down");
    ...
    void InitializeSt7789Display() {
        ...
        {
            esp_lcd_panel_swap_xy(panel, DISPLAY_SWAP_XY_POR);
            esp_lcd_panel_mirror(panel, DISPLAY_MIRROR_X_POR, DISPLAY_MIRROR_Y_POR);
            display_ = new SpiLcdDisplay(panel_io, panel,
                                    DISPLAY_WIDTH_POR, DISPLAY_HEIGHT_POR, DISPLAY_OFFSET_X, DISPLAY_OFFSET_Y, DISPLAY_MIRROR_X_POR, DISPLAY_MIRROR_Y_POR, DISPLAY_SWAP_XY_POR);
        }  
#endif   
    }
...
DECLARE_BOARD(ICECATK2BOARD_ML307);
